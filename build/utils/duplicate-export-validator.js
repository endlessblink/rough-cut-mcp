...
exports.validateDuplicateExports = validateDuplicateExports;
exports.processDuplicateExports = processDuplicateExports;
exports.validateAdvancedDuplicates = validateAdvancedDuplicates;
/**
 * Detects and fixes duplicate exports in TypeScript/JSX code
 */
function validateDuplicateExports(code) {
    const errors = [];
    const duplicates = [];
 ...
 */
function processDuplicateExports(code) {
 ...
 */
function validateAdvancedDuplicates(code) {
    const errors = [];
    let correctedCode = code;
 ...
 */
function removeCompleteVideoCompositionBlocks(code) {
    const lines = code.split('\n');
    const toRemove = [];
...
const exportMap = new Map();
//# sourceMappingURL=duplicate-export-validator.js.map