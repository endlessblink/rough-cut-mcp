...
exports.validateComponentStructure = validateComponentStructure;
exports.processComponentStructure = processComponentStructure;
exports.generateSafeIndexTs = generateSafeIndexTs;
exports.generateSafeRootTsx = generateSafeRootTsx;
 ...
 */
function validateComponentStructure(code) {
    const errors = [];
    const warnings = [];
 ...
 */
function processComponentStructure(code) {
 ...
 */
function generateSafeRootTsx(options = {}) {
    const { compositionId = 'VideoComposition', fps = 30, durationInFrames = 240, width = 1920, height = 1080 } = options;
