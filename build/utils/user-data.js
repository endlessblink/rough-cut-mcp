 ...
 */
export async function initializeUserDataDirectory() {
 ...
 */
export async function copyEssentialTemplates(sourceTemplatesDir, userTemplatesDir) {
    try {
 ...
 */
export async function migrateExistingProjects(oldProjectsDir, newProjectsDir) {
