...
export class ContextManager extends EventEmitter {
     ...
     */
    addItem(id, type, weight, priority = 5, required = false, metadata) {
    ...
    optimize(targetWeight) {
        ...
        for (const item of sortedItems) {
            if (result.weightFreed >= weightToFree)
                break;
     ...
     */
    getRequiredReduction(additionalWeight) {
