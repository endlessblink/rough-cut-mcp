 ...
 */
export function validateEasing(code: string): EasingValidationResult {
  const errors: string[] = [];
 ...
 */
export function processEasingInCode(code: string): string {
 ...
 */
export const SAFE_EASING_EXAMPLES = `
