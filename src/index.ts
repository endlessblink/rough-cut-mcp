...
class RemotionMCPServer {
  ...
  constructor() {
    ...
    console.error(`[DEBUG] MCP Server Version: 9.4.1`);
    ...
    this.server = new Server(
      {
        name: 'rough-cut-mcp',
        version: '9.4.1' // Universal Structure Preservation + Polish Fixes (AbsoluteFill, Backgrounds, Timeouts)
      },
      {
        capabilities: {
          tools: {},
  ...
  private setupVersionOverride() {
    ...
    console.error(`[VERSION-OVERRIDE] MCP SERVER VERSION: 9.4.1`);
    ...
    console.error(`[MCP-INIT] Server created with version 9.4.1`);
    console.error(`[MCP-INIT] Protocol version: 2024-11-05`);
    console.error(`[MCP-INIT] This should show as Running Version: 9.4.1`);
  }
  ...
  private setupErrorHandling() {
    ...
    console.error(`[MCP-ERROR-SETUP] Version 9.4.1 error handling active`);
