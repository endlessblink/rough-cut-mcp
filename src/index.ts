...
class RemotionMCPServer {
  ...
  constructor() {
    ...
    console.error(`[DEBUG] MCP Server Version: 11.0.0`);
    ...
    this.server = new Server(
      {
        name: 'rough-cut-mcp',
        version: '11.0.0' // Simple Remotion-Native Approach - Working Videos Over Complex CSS
      },
      {
        capabilities: {
          tools: {},
  ...
  private setupVersionOverride() {
    ...
    console.error(`[VERSION-OVERRIDE] MCP SERVER VERSION: 11.0.0`);
    ...
    console.error(`[MCP-INIT] Server created with version 11.0.0`);
    console.error(`[MCP-INIT] Protocol version: 2024-11-05`);
    console.error(`[MCP-INIT] This should show as Running Version: 11.0.0`);
  }
  ...
  private setupErrorHandling() {
    ...
    console.error(`[MCP-ERROR-SETUP] Version 11.0.0 error handling active`);
