...
class RemotionMCPServer {
  ...
  constructor() {
    ...
    console.error(`[DEBUG] MCP Server Version: 9.6.0`);
    ...
    this.server = new Server(
      {
        name: 'rough-cut-mcp',
        version: '9.6.0' // Professional Icon Quality - Fixed Dependency Timing for Visual Excellence
      },
      {
        capabilities: {
          tools: {},
  ...
  private setupVersionOverride() {
    ...
    console.error(`[VERSION-OVERRIDE] MCP SERVER VERSION: 9.6.0`);
    ...
    console.error(`[MCP-INIT] Server created with version 9.6.0`);
    console.error(`[MCP-INIT] Protocol version: 2024-11-05`);
    console.error(`[MCP-INIT] This should show as Running Version: 9.6.0`);
  }
  ...
  private setupErrorHandling() {
    ...
    console.error(`[MCP-ERROR-SETUP] Version 9.6.0 error handling active`);
