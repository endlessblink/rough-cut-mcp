// Reusable animation primitives and components
 ...
 */
export const walkCyclePrimitive: AnimationPrimitive = {
  name: 'walk-cycle',
  ...
  generateCode: (params) => {
    ...
    const frames = characterSets[characterType as keyof typeof characterSets] || characterSets.ascii;
 ...
 */
export const physicsBounce: AnimationPrimitive = {
  name: 'physics-bounce',
 ...
 */
export const smoothRotation: AnimationPrimitive = {
  ...
  const rotation = interpolate(
    frame,
    [0, durationInFrames],
    [0, ${totalDegrees}]${easingOptions[easing as keyof typeof easingOptions] || ''}
  );`;
  }
};
 ...
 */
export const typewriterText: AnimationPrimitive = {
 ...
 */
export const fadeTransition: AnimationPrimitive = {
 ...
 */
export const scaleAnimation: AnimationPrimitive = {
 ...
 */
export const pathFollowing: AnimationPrimitive = {
  name: 'path-following',
  ...
  const y = baseY + Math.sin(frame * waveFrequency) * waveAmplitude;`
    ...
    return paths[pathType as keyof typeof paths] || paths.linear;
  }
};
 ...
 */
export function getAllPrimitives(): AnimationPrimitive[] {
  return [
    walkCyclePrimitive,
    physicsBounce,
    smoothRotation,
 ...
 */
export function getPrimitive(name: string): AnimationPrimitive | null {
 ...
 */
export function combinePrimitives(
  primitives: Array<{ name: string; params: any }>,
  baseParams: any
): string {
