...
export function createVoiceTools(config: MCPConfig): Tool[] {
  return [
    {
      name: 'generate-voice',
...
export function createVoiceHandlers(config: MCPConfig) {
  ...
  return {
    ...
    'get-voice-details': async (args: any) => {
      if (!elevenlabsService) {
    ...
    'test-voice-generation': async (args: any) => {
      if (!elevenlabsService) {
    ...
    'batch-generate-voice': async (args: any) => {
      if (!elevenlabsService) {
