...
export function createStudioHandlers(config: MCPConfig): ToolHandlers {
  ...
  const handlers: any = {
    ...
    'kill-studio-on-port': async (args: any) => {
    ...
    'get-active-studios': async () => {
      ...
      try {
        ...
        const listeningPorts: { port: number; pid: string }[] = [];
    ...
    'kill-all-studios': async (args: any) => {
    ...
    'find-available-port': async (args: any) => {
    ...
    'check-version-conflicts': async (args: any) => {
    ...
    'restart-studio-on-port': async (args: any) => {
    ...
    'clear-project-cache': async (args: any) => {
    ...
    'diagnose-studio-health': async (args: any) => {
      ...
      try {
        ...
        const failedChecks = diagnosis.checks.filter((c: any) => c.status === 'fail').length;
