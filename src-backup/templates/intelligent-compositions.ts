// Intelligent composition generator that combines animation primitives
...
export class IntelligentCompositionGenerator {
  private logger = getLogger().service('IntelligentComposition');
   ...
   */
  private findBestTemplate(animationType: AnimationType): CompositionTemplate | null {
  ...
  private buildComposition(
    ...
    const primitiveCode = combinePrimitives(
      template.primitives.map(p => ({ name: p.name, params: { ...p.params, ...customizations } })),
      baseParams
    );
  ...
  private getCharacterWalkTemplate(): string {
...
export const VideoComposition: React.FC = () => {
  ...
  private getBouncingObjectTemplate(): string {
    return `import React from 'react';
import {
  AbsoluteFill,
  interpolate,
...
export const VideoComposition: React.FC = () => {
  ...
  private getRotatingElementTemplate(): string {
    return `import React from 'react';
import {
  AbsoluteFill,
  interpolate,
...
export const VideoComposition: React.FC = () => {
  ...
  private getTextTypewriterTemplate(): string {
    return `import React from 'react';
import {
  AbsoluteFill,
  interpolate,
...
export const VideoComposition: React.FC = () => {
  ...
  private getFadeTransitionTemplate(): string {
    return `import React from 'react';
import {
  AbsoluteFill,
  interpolate,
...
export const VideoComposition: React.FC = () => {
  ...
  private getSlidingElementTemplate(): string {
    return `import React from 'react';
import {
  AbsoluteFill,
  interpolate,
